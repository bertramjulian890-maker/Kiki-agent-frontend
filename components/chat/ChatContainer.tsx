    ...
    return (
        <div className="relative flex h-full flex-1 flex-col overflow-hidden text-(--charcoal-700)">
            ...
            <section className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
                <div className="mx-auto w-full max-w-3xl px-4 py-8 pb-40">
                    <MessageList
                        messages={messages}
                        isLoading={isLoading}
                        error={error}
            ...
            {/* 输入框定位 */}
            <footer className="fixed bottom-10 left-0 right-0 md:absolute md:bottom-8 px-4 z-10 pointer-events-none drop-shadow-xl">
                <div className="mx-auto max-w-3xl pointer-events-auto flex justify-center">
                    <ChatInput
                        isLoading={isLoading}
                        onSend={onSend}
                        onStop={onStop}
